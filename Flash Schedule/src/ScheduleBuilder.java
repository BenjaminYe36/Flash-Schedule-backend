	...
	public static String toJSONString(Set<Set<Combo>> possibleSchedules) {
		...
		for (Set<Combo> oneSchedule : possibleSchedules) {
			...
			for (Combo combo : oneSchedule) {
				...
				timeObjLecture.put("lectureFrom", mtLecture.getStartTime());
				timeObjLecture.put("lectureTo", mtLecture.getEndTime());
				...
				if (combo.getQuiz() != null) {
					...
					timeObjQuiz.put("lectureFrom", mtQuiz.getStartTime());
					timeObjQuiz.put("lectureTo", mtQuiz.getEndTime());
